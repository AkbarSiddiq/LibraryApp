    ...
    <>
      ...
      <div className="flex">
        <div className="flex flex-col w-64 h-screen px-4 py-8 overflow-y-auto border-r">
          <h2 className="text-3xl font-semibold text-center text-blue-800">Books</h2>
          ...
          <div className="flex flex-col justify-between mt-6">
            <div>
              <ul>
                ...
                <li>
                  <a onClick={logout} className="flex cursor-pointer items-center px-4 py-2 mt-5 text-gray-600 rounded-md hover:bg-gray-200">
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
          ...
          <div className="flex items-center justify-center ">
            <div className="bg-gray-700 h-full w-full">
              <div className="lg:grid lg:grid-cols-3 lg:gap-2 grid-row place-content-center mx-8">
                {firedata.map((data) => {
                  return (
                    <div className="flex max-w-md bg-gray-300 shadow-lg rounded-lg overflow-hidden my-8">
                      <img
                        ...
                        className="w-1/3 object-cover bg-landscape"
                      ></img>
                      <div className="w-2/3 p-4">
                        <h1 className="text-gray-900 font-bold text-2xl">{data.title}</h1>
                        <p className="mt-2 text-gray-600 text-sm">{data.sinops}</p>
                        <p className="mt-2 text-gray-600 text-sm">Pages: {data.pages}</p>
                        <p className="mt-2 text-gray-600 text-sm">Availibility: {data.availibility}</p>
                        <div className="flex item-center justify-between mt-3">
                          <button className="px-3 py-2 bg-gray-800 text-white text-xs font-bold uppercase rounded" onClick={updateAvailibility}>
                            Borrow
                          </button>
                        </div>
                      </div>
