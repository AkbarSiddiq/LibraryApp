  ...
  return (
    <div>
      ...
      <div className="py-24 px-10 bg-gray-400 h-full w-full absolute">
        <div className="flex">
          <img className="w-2/4 md:w-50 mx-10 " src="https://images.unsplash.com/photo-1457369804613-52c61a468e7d?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxzZWFyY2h8NTh8fGJvb2t8ZW58MHx8MHx8&auto=format&fit=crop&w=500&q=60"></img>
          <div class="flex flex-col w-full max-w-md px-4 py-8 bg-white rounded-lg shadow dark:bg-gray-800 sm:px-6 md:px-8 lg:px-10">
            <div class="self-center mb-6 text-xl font-light text-gray-600 sm:text-2xl dark:text-white">Register Your Account</div>
            <div class="mt-8">
                ...
                <div class="flex flex-col mb-6">
                  ...
                  <div class="flex w-full">
                    <button
                      type="submit"
                      onClick={signup}
                      class="py-2 my-4 px-4  bg-purple-600 hover:bg-purple-700 focus:ring-purple-500 focus:ring-offset-purple-200 text-white w-full transition ease-in duration-200 text-center text-base font-semibold shadow-md focus:outline-none focus:ring-2 focus:ring-offset-2  rounded-lg "
                    >
                      Sign Up
                    </button>
                  </div>
                  <div class="self-center mb-6 text-xl font-light text-gray-600 sm:text-2xl dark:text-white my-2">Register With Google Account</div>
                  <button
                    type="button"
